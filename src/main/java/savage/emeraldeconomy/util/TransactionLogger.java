...
public class TransactionLogger {
    ...
    public static void log(String type, String source, String target, BigDecimal amount, String details) {
        EXECUTOR.submit(() -> {
            ...
            savage.emeraldeconomy.storage.EconomyStorage storage = savage.emeraldeconomy.EconomyManager.getStorage();
            if (storage instanceof savage.emeraldeconomy.storage.SqliteStorage) {
            ...
            try (FileWriter fw = new FileWriter(LOG_FILE, true);
                ...
                EmeraldEconomy.LOGGER.error("Failed to write to economy log", e);
            }
        });
    }
        ...
        try (java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.FileReader(LOG_FILE))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    // EmeraldEconomy.LOGGER.warn("Malformed log line: " + line);
                }
            }
        } catch (IOException e) {
            EmeraldEconomy.LOGGER.error("Failed to read economy log", e);
        }
