...
public class EmeraldEconomyAccount implements EconomyAccount {
    private final GameProfile profile;
    private final EconomyCurrency currency;
    private final EconomyProvider provider;

    public EmeraldEconomyAccount(GameProfile profile, EconomyCurrency currency, EconomyProvider provider) {
    ...
    public Identifier id() {
        return Identifier.of("emerald_economy", profile.id().toString());
    }
